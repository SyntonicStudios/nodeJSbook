...
// Install Passport middleware into the Express configuration
exports.initPassport = function(app) {
  app.use(passport.initialize());
  app.use(passport.session());
};

// This function will be inserted into any route definition that 
// requires an authenticated logged-in user. 
